...
async def list_tools() -> List[Tool]:
    """Define all MCP tools for ReportMiner"""
    return[
        # === CORE DOCUMENT TOOLS ===
        Tool(
...
# === CORE DOCUMENT TOOL IMPLEMENTATIONS ===
...
def check_system_status():
    ...
    try:
        ...
        print(f"🛠️ Available Tools: 4 (core document tools)")
        print(f"🎯 Ready for document queries and RAG processing!")
