"""
Temporary model fix for testing without pgvector
"""
import uuid
from django.db import models

# Temporary fix: Comment out pgvector import for testing
try:
    from pgvector.django import VectorField
    PGVECTOR_AVAILABLE = True
except ImportError:
    PGVECTOR_AVAILABLE = False
    # Create a dummy VectorField for testing
    class VectorField(models.Field):
        ...
        def db_type(self, connection):
            return 'TEXT'  # Fallback to TEXT for testing
...
class DocumentTextSegment(models.Model):
    ...
    if PGVECTOR_AVAILABLE:
        ...
        # Store as JSON text for testing
